    ...
    <section id="featured-courses" class="featured-courses section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="course-card">
              ...
              <div class="course-content">
                ...
                <a href="enrollPage" class="btn-course">Enroll Now</a>
              </div>
            </div>
          </div><!-- End Course Item -->
        ...
        <div class="more-courses text-center" data-aos="fade-up" data-aos-delay="500">
          <a href="coursesPage" class="btn-more">View All Courses</a>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="100">
            <a href="coursesPage" class="category-card category-tech">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="150">
            <a href="coursesPage" class="category-card category-business">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="200">
            <a href="coursesPage" class="category-card category-design">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="250">
            <a href="coursesPage" class="category-card category-health">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="300">
            <a href="coursesPage" class="category-card category-language">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="350">
            <a href="coursesPage" class="category-card category-science">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="100">
            <a href="coursesPage" class="category-card category-marketing">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="150">
            <a href="coursesPage" class="category-card category-finance">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="200">
            <a href="coursesPage" class="category-card category-photography">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="250">
            <a href="coursesPage" class="category-card category-music">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="300">
            <a href="coursesPage" class="category-card category-engineering">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="350">
            <a href="coursesPage" class="category-card category-law">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="100">
            <a href="coursesPage" class="category-card category-culinary">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="150">
            <a href="coursesPage" class="category-card category-sports">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="200">
            <a href="coursesPage" class="category-card category-writing">
              <div class="category-icon">
                <i class="bi bi-pen"></i>
              </div>
              <h5>Writing</h5>
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="250">
            <a href="coursesPage" class="category-card category-psychology">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="300">
            <a href="coursesPage" class="category-card category-environment">
              <div class="category-icon">
          ...
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6" data-aos="zoom-in" data-aos-delay="350">
            <a href="coursesPage" class="category-card category-communication">
              <div class="category-icon">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="blog-detailsPage">Sed ut perspiciatis unde omnis iste natus</a></h5>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="card position-relative">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="blog-detailsPage">Nemo enim ipsam voluptatem quia voluptas sit</a></h5>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="blog-detailsPage">Ut enim ad minima veniam, quis nostrum exercitationem</a></h5>
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="cta-content">
              ...
              <div class="cta-actions" data-aos="fade-up" data-aos-delay="500">
                <a href="coursesPage" class="btn btn-primary">Browse Courses</a>
                <a href="enrollPage" class="btn btn-outline">Enroll Now</a>
              </div>
